...
public:
    ...
    /**
     * @brief Register ActorComponent in this context
     * @tparam T component type (must have `inspect` method)
     */
    template <class T>
    void registerComponent();

    /**
     * @brief Register Event in this context.
     * @tparam T event type (must have `inspect` method)
     */
    template <class T>
    void registerEvent();
